...
public class Management {
			...
			if(role.equals("client")){
				...
				switch (leChoix){
					...
					case 4:
						...
						break;
					case 5:
						System.out.println("Health & life est une entreprise cosmétique située en plein centre-ville de Kinshasa.  Crée en 2011, elle est aujourd’hui la meilleure");
						System.out.println("L’entreprise a pour objectif de rendre accessible les produits venant des pays extérieurs à la population congolaise. Ayant pour fournisseur, des partenaires en France, en chine, au japon");					
						System.out.println("Elle se donne comme mandat de partager sa vision au grand public en créant une communauté qui changera la perception sur l’industrie des cosmétiques.");
						System.out.println("L’entreprise désire partager sa vision afin d’encourager un mode de vie sain pour amener le corps à être en symbiose avec l’esprit.");
						System.out.println("Ainsi, chaque être humain valorisera davantage sa beauté intérieure");
						break;
					case 6:
						cont=false;
  ...
  //Methode pour creer une categorie
	...
	//Methode de création de commande
	public void creerCommande(){
		int i=1;
		int qte;
		String choix;
		for(Article Art:lesArticles2){
			System.out.println(i+") "+Art.getLibelleArticle()+" : Prix = "+Art.getPrixArticle()+" :Quanttié= "+Art.getQuantiteDisponibleArticle()+" Taxe= "+Art.getTaxeArticle());
			i++;
		}
			...
			if(choix.equals(Art.getLibelleArticle())){
				if(Art.getQuantiteDisponibleArticle()==0){
					...
					if(choix.equals("OUI")){
						...
						System.out.println("Votre commande a été annuléé ");
					}
				}
			}
		}
	...
	public String MenuAdmin(){
    	...
    	System.out.println("*4) Consulter les clients enregistrés sur le site web               *");
