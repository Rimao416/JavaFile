...
public class TestVoiture {
	...
	public static void main(String[] args) {
       ...
       c1.louerVoiture(V2);
       c1.louerVoiture(V3);
       System.out.println("le nombre de voiture louées est: "+ c1.getNb_Voitures());
       c1.afficherVoitures();
       ...
       c1.louerVoiture(V4);
       System.out.println("le nombre de voiture louées est: "+ c1.getNb_Voitures());
       for (int i = 0; i <c1.getMesvoitures().length; i++)
       {
    	   if( (c1.getMesvoitures())[i] != null)
    	   {
    		   System.out.println( (c1.getMesvoitures())[i] );
    	   }
       }
	}
